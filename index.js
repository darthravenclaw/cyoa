...
function forest() {
    ...
    if (answer == "Candy house") {
        ...
        if (hang == 3) {
            ...
            story("Do you plan to hang out here all day?");
            wait();
            forest();
        } else if (hang == 4) {
            story("Is your name Hamlet?");
            story("You know trying something is better than doing nothing all day.");
            wait();
            forest();
        } else if (hang == 5) {
            story("Ok you do you.");
        ...
        if (spin == 3) {
            ...
            story("It makes me a little nauseous just to watching you");
        } else if (spin == 4) {
...
function candyHouse() {
    ...
    if (answer == "talk to her") {
        witch("Well hello little one. You look good enough to eat.");
        witch("Why don't you sit down and have some tea?");
        if (poisonedApple) {
